...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
		...
		wp_register_script( 'form-script', 'https://requestforms.learninghouse.com/form/affiliate/814', array(), '', false );
    ...
    if ( is_singular() AND comments_open() AND (get_option('thread_comments') == 1)) {
		...
		wp_register_script( 'bones-js', get_stylesheet_directory_uri() . '/library/js/build/production.js', array( 'jquery' ), '', true );
